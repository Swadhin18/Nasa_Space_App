  ...
  return (
    <>
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          ...
          <div className="flex items-center justify-between">
            ...
            <a href="/" className="group flex items-center gap-4">
              ...
              <div className="hidden md:block">
                ...
                <div className="text-xs text-cyan-400 font-mono tracking-wider">OCEAN INTELLIGENCE</div>
              </div>
            </a>
              ...
              {navItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Active Indicator */}
                    <div className={`absolute inset-0 rounded-full border-2 border-cyan-400/40 transition-all duration-300 ${
                      activeSection === item.section ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
                    }`} />
            ...
            {/* Mission Status & Mobile Toggle */}
            <div className="flex items-center gap-4">
              
              {/* Mission Status (Hidden on mobile) */}
        ...
        <div className={`h-1 bg-gradient-to-r from-transparent via-cyan-400 to-transparent transition-all duration-500 ${
      ...
      <div className={`fixed inset-0 z-40 lg:hidden transition-all duration-500 ${
        ...
        {/* Mobile Menu Content */}
        <div className={`absolute top-0 right-0 h-full w-80 bg-gradient-to-b from-slate-900 to-slate-800 border-l border-cyan-400/20 shadow-2xl transform transition-transform duration-500 ${
          ...
          <div className="p-6 space-y-4">
            {navItems.map((item, index) => {
              ...
              return (
                ...
                >
                  <div className={`p-2 rounded-lg bg-gradient-to-br transition-all duration-300 ${
                    activeSection === item.section
          ...
          <div className="absolute bottom-6 left-6 right-6">
            <div className="p-4 rounded-xl bg-slate-800/50 border border-slate-700/50 backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-cyan-300 font-semibold text-sm">Ocean Intelligence Active</span>
              </div>
