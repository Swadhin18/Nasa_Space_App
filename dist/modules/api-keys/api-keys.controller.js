...
let ApiKeysController = (() => {
    let _classDecorators = [(0, common_1.Controller)('api-keys')];
    ...
    var ApiKeysController = class {
        ...
        static {
            ...
            _create_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Post)('create')];
            _revoke_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Post)('revoke/:id')];
            _my_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Get)('my')];
            ...
            __esDecorate(this, null, _my_decorators, { kind: "method", name: "my", static: false, private: false, access: { has: obj => "my" in obj, get: obj => obj.my }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            ApiKeysController = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        keysService = __runInitializers(this, _instanceExtraInitializers);
